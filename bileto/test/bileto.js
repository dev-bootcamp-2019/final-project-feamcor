...
contract('Bileto', async (accounts) => {
  ...
  it("should store event basic info accordingly", async () => {
    ...
    assert.strictEqual(_info._organizer, __organizer1, "event organizer address is incorrect");
  ...
  it("should store purchase info accordingly", async () => {
    ...
    assert.strictEqual(_info._customer, __customer1, "customer address is incorrect");
